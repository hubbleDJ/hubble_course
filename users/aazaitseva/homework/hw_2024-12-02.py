...
def maxNumList(numbers: list[int]) -> int:
    """Находит максимальное значение в списке Использовать функцию max нельзя.
...
def minNumList(numbers: list[int]) -> int:
    """Находит минимальное значение в списке Использовать функцию min нельзя.
...
def sumNumbersInList(numbers: list[int]) -> int:
    """Находит сумму значений в списке Использовать функцию sum нельзя.
